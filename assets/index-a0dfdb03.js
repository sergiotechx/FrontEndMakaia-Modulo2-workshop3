...
`;const zo=Symbol(),qn=Symbol();let Zl;const Jl=new Map;let jt=class extends R{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(e,t){var r;let i;if(t!=null&&t.spriteSheet)return $`<svg part="svg">
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Nf=Symbol.for(""),mv=e=>{if((e==null?void 0:e.r)===Nf)return e==null?void 0:e._$litStatic$},Bs=(e,...t)=>({_$litStatic$:t.reduce((r,i,o)=>r+(n=>{if(n._$litStatic$!==void 0)return n._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${n}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(i)+e[o+1],e[0]),r:Nf}),Hd=new Map,gv=e=>(t,...r)=>{const i=r.length;let o,n;const s=[],c=[];let a,u=0,m=!1;for(;u<i;){for(a=t[u];u<i&&(n=r[u],(o=mv(n))!==void 0);)a+=o+t[++u],m=!0;u!==i&&c.push(n),s.push(a),u++}if(u===i&&s.push(t[i]),m){const h=s.join("$$lit$$");(t=Hd.get(h))===void 0&&(s.raw=s,Hd.set(h,t=s)),r=c}return e(t,...r)},Yo=gv($);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const N=e=>e??we;var vv=V`
  ${U}
...
`;let mi=class extends R{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return $`
      <slot
        part="base"
...
`;let gi=class extends R{constructor(){super(...arguments),this.hasSlotController=new Dt(this,"prefix","suffix"),this.rel="noreferrer noopener"}render(){const e=!!this.href;return $`
      <div
        part="base"
...
`;let Us=class extends R{constructor(){super(...arguments),this.localize=new ne(this)}render(){return $`
...
`;let Kt=class extends R{constructor(){super(...arguments),this.hasError=!1,this.image="",this.label="",this.initials="",this.loading="eager",this.shape="circle"}handleImageChange(){this.hasError=!1}render(){const e=$`
      <img
        part="image"
        class="avatar__image"
        src="${this.image}"
...
`;let Hs=class extends R{constructor(){super(...arguments),this.hasSlotController=new Dt(this,"footer","header","image")}render(){return $`
      <div
        part="base"
...
`;let bn=class extends R{static isCarouselItem(e){return e instanceof Element&&e.getAttribute("aria-roledescription")==="slide"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","group")}render(){return $` <slot></slot> `}};bn.styles=Pb;bn=l([B("sl-carousel-item")],bn);var Ob=V`
  ${U}
...
`;let wt=class extends R{constructor(){super(),this.type="normal",this.checked=!1,this.value="",this.disabled=!1,this.handleHostClick=e=>{this.disabled&&(e.preventDefault(),e.stopImmediatePropagation())},this.addEventListener("click",this.handleHostClick)}handleDefaultSlotChange(){const e=this.getTextLabel();if(typeof this.cachedTextLabel>"u"){this.cachedTextLabel=e;return}e!==this.cachedTextLabel&&(this.cachedTextLabel=e,this.emit("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}handleCheckedChange(){if(this.checked&&this.type!=="checkbox"){this.checked=!1,console.error('The checked attribute can only be used on menu items with type="checkbox"',this);return}this.type==="checkbox"?this.setAttribute("aria-checked",this.checked?"true":"false"):this.removeAttribute("aria-checked")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleTypeChange(){this.type==="checkbox"?(this.setAttribute("role","menuitemcheckbox"),this.setAttribute("aria-checked",this.checked?"true":"false")):(this.setAttribute("role","menuitem"),this.removeAttribute("aria-checked"))}getTextLabel(){return wv(this.defaultSlot)}render(){return $`
      <div
        part="base"
...
`;let Qs=class extends R{render(){return $` <slot part="base" class="menu-label"></slot> `}};Qs.styles=I1;Qs=l([B("sl-menu-label")],Qs);F({tagName:"sl-menu-label",elementClass:Qs,react:M,events:{}});var P1=V`
  ${U}
...
`;let _t=class extends R{constructor(){super(...arguments),this.localize=new ne(this),this.current=!1,this.selected=!1,this.hasHover=!1,this.value="",this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","option"),this.setAttribute("aria-selected","false")}handleDefaultSlotChange(){const e=this.getTextLabel();if(typeof this.cachedTextLabel>"u"){this.cachedTextLabel=e;return}e!==this.cachedTextLabel&&(this.cachedTextLabel=e,this.emit("slotchange",{bubbles:!0,composed:!1,cancelable:!1}))}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleValueChange(){typeof this.value!="string"&&(this.value=String(this.value)),this.value.includes(" ")&&(console.error("Option values cannot include a space. All spaces have been replaced with underscores.",this),this.value=this.value.replace(/ /g,"_"))}getTextLabel(){var e;return((e=this.textContent)!=null?e:"").trim()}render(){return $`
      <div
        part="base"
...
`;let _i=class extends R{constructor(){super(...arguments),this.localize=new ne(this),this.value=0,this.indeterminate=!1,this.label=""}render(){return $`
      <div
        part="base"
...
`;let jr=class extends R{constructor(){super(...arguments),this.localize=new ne(this),this.value=0,this.label=""}updated(e){if(super.updated(e),e.has("value")){const t=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),r=2*Math.PI*t,i=r-this.value/100*r;this.indicatorOffset=`${i}px`}}render(){return $`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
...
`;let xt=class extends R{constructor(){super(...arguments),this.value="",this.label="",this.size=128,this.fill="black",this.background="white",this.radius=0,this.errorCorrection="H"}firstUpdated(){this.generate()}generate(){this.hasUpdated&&N1.render({text:this.value,radius:this.radius,ecLevel:this.errorCorrection,fill:this.fill,background:null,size:this.size*2},this.canvas)}render(){var e;return $`
      ...
      ></canvas>
    `}};xt.styles=R1;l([I("canvas")],xt.prototype,"canvas",2);l([d()],xt.prototype,"value",2);l([d()],xt.prototype,"label",2);l([d({type:Number})],xt.prototype,"size",2);l([d()],xt.prototype,"fill",2);l([d()],xt.prototype,"background",2);l([d({type:Number})],xt.prototype,"radius",2);l([d({attribute:"error-correction"})],xt.prototype,"errorCorrection",2);l([T(["background","errorCorrection","fill","radius","size","value"])],xt.prototype,"generate",1);xt=l([B("sl-qr-code")],xt);F({tagName:"sl-qr-code",elementClass:xt,react:M,events:{}});var M1=V`
  ${U}
...
`;let Ne=class extends R{constructor(){super(...arguments),this.formControlController=new br(this),this.hasSlotController=new Dt(this,"help-text","label"),this.customValidityMessage="",this.hasButtonGroup=!1,this.errorMessage="",this.defaultValue="",this.label="",this.helpText="",this.name="option",this.value="",this.size="medium",this.form="",this.required=!1}get validity(){const e=this.required&&!this.value;return this.customValidityMessage!==""?kb:e?xb:ml}get validationMessage(){const e=this.required&&!this.value;return this.customValidityMessage!==""?this.customValidityMessage:e?this.validationInput.validationMessage:""}connectedCallback(){super.connectedCallback(),this.defaultValue=this.value}firstUpdated(){this.formControlController.updateValidity()}getAllRadios(){return[...this.querySelectorAll("sl-radio, sl-radio-button")]}handleRadioClick(e){const t=e.target.closest("sl-radio, sl-radio-button"),r=this.getAllRadios(),i=this.value;t.disabled||(this.value=t.value,r.forEach(o=>o.checked=o===t),this.value!==i&&(this.emit("sl-change"),this.emit("sl-input")))}handleKeyDown(e){var t;if(!["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"," "].includes(e.key))return;const r=this.getAllRadios().filter(c=>!c.disabled),i=(t=r.find(c=>c.checked))!=null?t:r[0],o=e.key===" "?0:["ArrowUp","ArrowLeft"].includes(e.key)?-1:1,n=this.value;let s=r.indexOf(i)+o;s<0&&(s=r.length-1),s>r.length-1&&(s=0),this.getAllRadios().forEach(c=>{c.checked=!1,this.hasButtonGroup||(c.tabIndex=-1)}),this.value=r[s].value,r[s].checked=!0,this.hasButtonGroup?r[s].shadowRoot.querySelector("button").focus():(r[s].tabIndex=0,r[s].focus()),this.value!==n&&(this.emit("sl-change"),this.emit("sl-input")),e.preventDefault()}handleLabelClick(){const e=this.getAllRadios(),r=e.find(i=>i.checked)||e[0];r&&r.focus()}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}async syncRadioElements(){var e,t;const r=this.getAllRadios();if(await Promise.all(r.map(async i=>{await i.updateComplete,i.checked=i.value===this.value,i.size=this.size})),this.hasButtonGroup=r.some(i=>i.tagName.toLowerCase()==="sl-radio-button"),!r.some(i=>i.checked))if(this.hasButtonGroup){const i=(e=r[0].shadowRoot)==null?void 0:e.querySelector("button");i&&(i.tabIndex=0)}else r[0].tabIndex=0;if(this.hasButtonGroup){const i=(t=this.shadowRoot)==null?void 0:t.querySelector("sl-button-group");i&&(i.disableRole=!0)}}syncRadios(){if(customElements.get("sl-radio")&&customElements.get("sl-radio-button")){this.syncRadioElements();return}customElements.get("sl-radio")?this.syncRadioElements():customElements.whenDefined("sl-radio").then(()=>this.syncRadios()),customElements.get("sl-radio-button")?this.syncRadioElements():customElements.whenDefined("sl-radio-button").then(()=>this.syncRadios())}updateCheckedRadio(){this.getAllRadios().forEach(t=>t.checked=t.value===this.value),this.formControlController.setValidity(this.validity.valid)}handleSizeChange(){this.syncRadios()}handleValueChange(){this.hasUpdated&&this.updateCheckedRadio()}checkValidity(){const e=this.required&&!this.value,t=this.customValidityMessage!=="";return e||t?(this.formControlController.emitInvalidEvent(),!1):!0}getForm(){return this.formControlController.getForm()}reportValidity(){const e=this.validity.valid;return this.errorMessage=this.customValidityMessage||e?"":this.validationInput.validationMessage,this.formControlController.setValidity(e),this.validationInput.hidden=!0,clearTimeout(this.validationTimeout),e||(this.validationInput.hidden=!1,this.validationInput.reportValidity(),this.validationTimeout=setTimeout(()=>this.validationInput.hidden=!0,1e4)),e}setCustomValidity(e=""){this.customValidityMessage=e,this.errorMessage=e,this.validationInput.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),r=this.label?!0:!!e,i=this.helpText?!0:!!t,o=$`
    ...
    `}};Ne.styles=B1;l([I("slot:not([name])")],Ne.prototype,"defaultSlot",2);l([I(".radio-group__validation-input")],Ne.prototype,"validationInput",2);l([j()],Ne.prototype,"hasButtonGroup",2);l([j()],Ne.prototype,"errorMessage",2);l([j()],Ne.prototype,"defaultValue",2);l([d()],Ne.prototype,"label",2);l([d({attribute:"help-text"})],Ne.prototype,"helpText",2);l([d()],Ne.prototype,"name",2);l([d({reflect:!0})],Ne.prototype,"value",2);l([d({reflect:!0})],Ne.prototype,"size",2);l([d({reflect:!0})],Ne.prototype,"form",2);l([d({type:Boolean,reflect:!0})],Ne.prototype,"required",2);l([T("size",{waitUntilFirstUpdate:!0})],Ne.prototype,"handleSizeChange",1);l([T("value")],Ne.prototype,"handleValueChange",1);Ne=l([B("sl-radio-group")],Ne);F({tagName:"sl-radio-group",elementClass:Ne,react:M,events:{onSlChange:"sl-change",onSlInput:"sl-input",onSlInvalid:"sl-invalid"}});var V1=V`
  ${U}
  ${An}
...
`;let Wr=class extends R{constructor(){super(...arguments),this.localize=new ne(this),this.variant="neutral",this.size="medium",this.pill=!1,this.removable=!1}handleRemoveClick(){this.emit("sl-remove")}render(){return $`
      <span
        part="base"
...
`;let kn=class extends R{constructor(){super(...arguments),this.effect="none"}render(){return $`
      <div
        part="base"
...
`;let G1=0,Xt=class extends R{constructor(){super(...arguments),this.localize=new ne(this),this.attrId=++G1,this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("sl-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}focus(e){this.tab.focus(e)}blur(){this.tab.blur()}render(){return this.id=this.id.length>0?this.id:this.componentId,$`
      <div
        part="base"
...
`;let ew=0,xi=class extends R{constructor(){super(...arguments),this.attrId=++ew,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return $`
      <slot
        part="base"
...
`;let Re=class extends R{constructor(){super(),this.localize=new ne(this),this.content="",this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleKeyDown=e=>{this.open&&e.key==="Escape"&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const e=jd(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const e=jd(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("keydown",this.handleKeyDown),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}connectedCallback(){super.connectedCallback()}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){if(this.open){if(this.disabled)return;this.emit("sl-show"),await Ee(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:e,options:t}=xe(this,"tooltip.show",{dir:this.localize.dir()});await _e(this.popup.popup,e,t),this.emit("sl-after-show")}else{this.emit("sl-hide"),await Ee(this.body);const{keyframes:e,options:t}=xe(this,"tooltip.hide",{dir:this.localize.dir()});await _e(this.popup.popup,e,t),this.popup.active=!1,this.body.hidden=!0,this.emit("sl-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,Ge(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Ge(this,"sl-after-hide")}render(){return $`
    ...
    `}};Re.styles=rw;l([I("slot:not([name])")],Re.prototype,"defaultSlot",2);l([I(".tooltip__body")],Re.prototype,"body",2);l([I("sl-popup")],Re.prototype,"popup",2);l([d()],Re.prototype,"content",2);l([d()],Re.prototype,"placement",2);l([d({type:Boolean,reflect:!0})],Re.prototype,"disabled",2);l([d({type:Number})],Re.prototype,"distance",2);l([d({type:Boolean,reflect:!0})],Re.prototype,"open",2);l([d({type:Number})],Re.prototype,"skidding",2);l([d()],Re.prototype,"trigger",2);l([d({type:Boolean})],Re.prototype,"hoist",2);l([T("open",{waitUntilFirstUpdate:!0})],Re.prototype,"handleOpenChange",1);l([T(["content","distance","hoist","placement","skidding"])],Re.prototype,"handleOptionsChange",1);l([T("disabled")],Re.prototype,"handleDisabledChange",1);Re=l([B("sl-tooltip")],Re);se("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}});se("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});F({tagName:"sl-tooltip",elementClass:Re,react:M,events:{onSlShow:"sl-show",onSlAfterShow:"sl-after-show",onSlHide:"sl-hide",onSlAfterHide:"sl-after-hide"}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
